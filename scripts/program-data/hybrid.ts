...
export const HYBRID_PROGRAM: DefaultProgram = {
  ...
  days: [
    // MONDAY — Push + Cardio
    {
      ...
      blocks: [
        // Treadmill intervals
        { block_order: 1, block_type: 'treadmill', section: 'warmup', duration_seconds: 180, incline: 0, intensity: 'base', outdoor_alternative: '3 min easy jog' },
        { block_order: 2, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 4, intensity: 'push', outdoor_alternative: '1 min uphill push' },
        { block_order: 3, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 0, intensity: 'base', outdoor_alternative: '1 min easy recovery' },
        { block_order: 4, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 6, intensity: 'all_out', outdoor_alternative: '1 min hard sprint' },
        { block_order: 5, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 0, intensity: 'base', outdoor_alternative: '1 min easy recovery' },
        { block_order: 6, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 4, intensity: 'push', outdoor_alternative: '1 min uphill push' },
        { block_order: 7, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 0, intensity: 'base', outdoor_alternative: '1 min easy recovery' },
        { block_order: 8, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 6, intensity: 'all_out', outdoor_alternative: '1 min hard sprint' },
        { block_order: 9, block_type: 'treadmill', section: 'warmup', duration_seconds: 120, incline: 0, intensity: 'base', outdoor_alternative: '2 min cooldown jog' },
        // Push strength
    ...
    // TUESDAY — Pull + Cardio
    {
      ...
      blocks: [
        { block_order: 1, block_type: 'treadmill', section: 'warmup', duration_seconds: 180, incline: 0, intensity: 'base', outdoor_alternative: '3 min easy jog' },
        { block_order: 2, block_type: 'treadmill', section: 'warmup', duration_seconds: 120, incline: 8, intensity: 'push', outdoor_alternative: '2 min hill climb' },
        { block_order: 3, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 0, intensity: 'base', outdoor_alternative: '1 min recovery' },
        { block_order: 4, block_type: 'treadmill', section: 'warmup', duration_seconds: 120, incline: 10, intensity: 'push', outdoor_alternative: '2 min steep hill' },
        { block_order: 5, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 0, intensity: 'base', outdoor_alternative: '1 min recovery' },
        { block_order: 6, block_type: 'treadmill', section: 'warmup', duration_seconds: 120, incline: 8, intensity: 'push', outdoor_alternative: '2 min hill climb' },
        { block_order: 7, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 0, intensity: 'base', outdoor_alternative: '1 min recovery' },
        // Pull strength
    ...
    // THURSDAY — Legs + Cardio
    {
      ...
      blocks: [
        { block_order: 1, block_type: 'treadmill', section: 'warmup', duration_seconds: 180, incline: 0, intensity: 'base', outdoor_alternative: '3 min easy jog' },
        { block_order: 2, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 3, intensity: 'push', outdoor_alternative: '1 min push pace' },
        { block_order: 3, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 0, intensity: 'base', outdoor_alternative: '1 min recovery' },
        { block_order: 4, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 5, intensity: 'all_out', outdoor_alternative: '1 min sprint' },
        { block_order: 5, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 0, intensity: 'base', outdoor_alternative: '1 min recovery' },
        { block_order: 6, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 3, intensity: 'push', outdoor_alternative: '1 min push pace' },
        { block_order: 7, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 0, intensity: 'base', outdoor_alternative: '1 min recovery' },
        { block_order: 8, block_type: 'treadmill', section: 'warmup', duration_seconds: 60, incline: 5, intensity: 'all_out', outdoor_alternative: '1 min sprint' },
        { block_order: 9, block_type: 'treadmill', section: 'warmup', duration_seconds: 120, incline: 0, intensity: 'base', outdoor_alternative: '2 min cooldown jog' },
        // Legs
