      ...
      <div className="bg-zinc-900 border border-zinc-800 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-scale-in max-h-[90vh] overflow-y-auto">
        ...
        <div className="relative p-6 pb-4 bg-gradient-to-b from-orange-950/30 to-transparent">
          ...
          <div className="text-center">
            ...
            {feature && (
              <p className="text-base text-orange-400 mt-1">{feature} is a premium feature</p>
            )}
            <p className="text-sm text-zinc-500 mt-2">Unlock the full RPG experience</p>
          </div>
        </div>
        ...
        <div className="px-6 pb-4 space-y-3">
          <button onClick={() => handleSubscribe('annual')} className="w-full p-4 bg-gradient-to-r from-orange-600 to-red-600 rounded-xl text-left relative overflow-hidden group">
            <div className="absolute top-2 right-2 text-xs font-bold bg-white/20 px-2 py-0.5 rounded uppercase">Best Value</div>
            <div className="text-white font-black text-lg">$59.99 / year</div>
            <div className="text-white/70 text-xs">$5.00/mo · Save 37%</div>
            <div className="text-white/50 text-xs mt-1">14-day free trial</div>
          </button>
        ...
        <div className="px-6 pb-4">
          <h3 className="text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2">Premium includes</h3>
        ...
        <div className="px-6 pb-6 space-y-2">
          <button onClick={handleRestore} className="w-full text-center text-xs text-zinc-600 hover:text-zinc-400 font-bold uppercase tracking-wider py-2 transition">
            Restore Purchases
          </button>
