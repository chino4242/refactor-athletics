        ...
        <div className="bg-zinc-900/50 border border-zinc-700/50 rounded-2xl p-6 shadow-xl backdrop-blur-sm animate-fade-in-up">
            <div className="flex items-center gap-2 mb-6 border-b border-zinc-700 pb-4">
                ...
                <div>
                    ...
                    <p className="text-base text-zinc-400 font-medium">Lifetime Bests & Winning Streaks</p>
                </div>
            </div>
            ...
            <div className="space-y-6">
                ...
                {/* 1. STREAKS ROW */}
                <div>
                    <h4 className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-3 pl-1">Active Streaks</h4>
                    <div className="grid grid-cols-2 gap-4">
                        <div className={`border rounded-xl p-4 flex flex-col justify-between transition-colors h-24 ${stats.habit_no_alcohol_tracked_today ? 'bg-emerald-900/10 border-emerald-900/30' : 'bg-zinc-900 border-zinc-800'}`}>
                            ...
                            <div className="text-2xl font-black text-white font-mono">{alcStreak} <span className="text-xs text-zinc-500 font-bold uppercase">Days</span></div>
                        </div>
                        ...
                        <div className={`border rounded-xl p-4 flex flex-col justify-between transition-colors h-24 ${stats.habit_no_vice_tracked_today ? 'bg-emerald-900/10 border-emerald-900/30' : 'bg-zinc-900 border-zinc-800'}`}>
                            ...
                            <div className="text-2xl font-black text-white font-mono">{viceStreak} <span className="text-xs text-zinc-500 font-bold uppercase">Days</span></div>
                        </div>
                    </div>
                </div>
                ...
                {/* 2. RECORDS ROW */}
                <div>
                    <h4 className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-3 pl-1">Lifetime Records</h4>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 flex flex-col justify-center h-24">
                            <div className="text-xs uppercase font-bold text-zinc-500 mb-1">Max Daily XP</div>
                            <div className="text-2xl font-black text-white font-mono">{dailyHigh.toLocaleString()}</div>
                        </div>

                        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 flex flex-col justify-center h-24">
                            <div className="text-xs uppercase font-bold text-zinc-500 mb-1">Max Weekly XP</div>
