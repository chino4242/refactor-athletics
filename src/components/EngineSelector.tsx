        ...
        return (
            <div className="w-full max-w-md mx-auto bg-zinc-900 rounded-3xl border border-zinc-800 p-6 space-y-6">
                <div className="text-center">
                    ...
                    <p className="text-zinc-500 text-base mt-1">How long do you want to go?</p>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <input
                        ...
                        className="flex-1 bg-zinc-800 border border-zinc-700 rounded-lg px-3 py-2 text-white text-base text-center font-mono focus:border-emerald-500 focus:outline-none"
                    />
    ...
    return (
        <div className="w-full max-w-md mx-auto bg-zinc-900 rounded-3xl border border-zinc-800 p-6 space-y-4">
            <div className="text-center mb-2">
                ...
                <p className="text-zinc-500 text-base mt-1">What kind of cardio today?</p>
            </div>
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center gap-2">
                            <div className="text-white font-black uppercase text-base">HIIT Intervals</div>
                            {recommendation === 'hiit' && <span className="text-xs bg-orange-500/20 text-orange-400 px-1.5 py-0.5 rounded font-bold uppercase">Recommended</span>}
                        </div>
                        <div className="text-zinc-500 text-sm mt-0.5">Today&apos;s programmed tread block</div>
                    </div>
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center gap-2">
                            <div className="text-white font-black uppercase text-base">Zone 2 Steady State</div>
                            {recommendation === 'zone2' && <span className="text-xs bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded font-bold uppercase">Recommended</span>}
                        </div>
                        <div className="text-zinc-500 text-sm mt-0.5">Conversational pace, pick your duration</div>
                    </div>
