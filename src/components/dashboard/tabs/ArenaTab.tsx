        ...
        <div className="space-y-4">
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
                    ...
                    {challenge75 ? (
                        <Link href="/challenge-75" className="block mt-3">
                            <div className="bg-zinc-800 rounded-lg p-3 hover:bg-zinc-700 transition">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-base font-bold text-white">{challenge75.title}</p>
                                        <p className="text-xs text-zinc-500">Day {challenge75.day}/75 · ✅ {challenge75.passed} days passed</p>
                                    </div>
                        ...
                        <div className="text-center py-6">
                            <p className="text-base text-zinc-400 mb-3">Commit to 75 days of daily discipline — track workouts, nutrition, and habits.</p>
                            <Link href="/challenge-75" className="inline-flex items-center gap-1 text-sm text-zinc-300 hover:text-white font-semibold">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
                <div className="flex items-center justify-between mb-1">
                    ...
                    <Link href="/arena" className="text-sm text-zinc-300 hover:text-white flex items-center gap-1">
                        View All
                        <ChevronRight size={14} />
                    </Link>
                </div>
                <p className="text-xs text-zinc-600 mb-3">Head-to-head challenges — outperform your opponent to win</p>
                {activeDuels.length > 0 ? (
                    ...
                    <div className="text-center py-6">
                        ...
                        <p className="text-base text-zinc-400 mb-3">{isClassic ? 'No active matchups. Challenge a friend!' : 'No active duels. Time to challenge someone!'}</p>
                        <Link 
                            href="/arena" 
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
                <div className="flex items-center justify-between mb-1">
                    ...
                    <button onClick={() => setShowCreate(true)} className="text-sm text-zinc-300 hover:text-white flex items-center gap-1 font-bold">
                        <Plus size={14} /> Create
                    </button>
                </div>
                <p className="text-xs text-zinc-600 mb-3">Open challenges anyone can join — share the link to invite others</p>
                {publicChallenges.length > 0 ? (
                            ...
                            <Link key={c.id} href={`/challenges/${c.id}`} className="block bg-zinc-800 rounded-lg p-3 hover:bg-zinc-700 transition">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-xs text-zinc-500">{c.public_challenge_participants?.length || 0} participants</p>
                                    </div>
                                    <ChevronRight size={14} className="text-zinc-600" />
                                </div>
                            </Link>
                    ...
                    <div className="text-center py-6">
                        ...
                        <p className="text-base text-zinc-400 mb-3">Create a challenge and share the link!</p>
                        <button onClick={() => setShowCreate(true)} className="inline-flex items-center gap-1 text-sm text-zinc-300 hover:text-white font-semibold">
